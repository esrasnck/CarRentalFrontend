...
const routes: Routes = [
 ...
 // {path:"cardetails/color/:colorId/brand/:brandId",component:CardetailComponent,pathMatch:"full"},
  ...
  {path:"rentaldetails",component:RentaldetailComponent} // bunu sor baturhan bey'e
